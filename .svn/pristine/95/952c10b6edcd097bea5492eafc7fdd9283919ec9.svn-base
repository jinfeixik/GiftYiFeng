...
<div class="page-container">
	<form class="form form-horizontal" id="submit" method="post" action="test/addGoods">
	
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>商品对象：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<!-- <input type="radio" class="input-text" id="goodsTypeObject" ="tbGoodsTypeInfo.goodsTypeObject" value="长辈">长辈 -->
		...
		function createbtn() {
			...
			if (nodenum < 5) {
				...
				node.innerHTML = "<label class='form-label col-xs-4 col-sm-2'></label>" 
					+ " <div class='col-xs-2 col-sm-2'><input id='goodsStyleName'  ='tbGoodsStyleInfo[" 
