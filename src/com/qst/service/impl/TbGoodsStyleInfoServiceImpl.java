...
public class TbGoodsStyleInfoServiceImpl extends HibernateDaoSupport  implements TbGoodsStyleInfoService{
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<TbGoodsImageInfo> findGoodsImageInfo(int goodsImageId) {
		// TODO Auto-generated method stub
		final int id = goodsImageId;
	...
	public int findImageIdStyle(Integer goodsStyleId) {
		return tbGoodsStyleInfoDao.findImageIdStyle(goodsStyleId);
		
	}

	@Override
	public int findGoodsIdStyle(Integer goodsStyleId) {
		return tbGoodsStyleInfoDao.findGoodsIdStyle(goodsStyleId);
	}
	...
	public void updateStock(TbGoodsStyleInfo tbGoodsStyleInfo){
		tbGoodsStyleInfoDao.updateStock(tbGoodsStyleInfo);
	}
	...
	public TbGoodsStyleInfo findGoodsStyleInfoService(int goodStyleId) {
		...
		return tbGoodsStyleInfoDao.findGoodsStyleInfoService(goodStyleId);
	}
