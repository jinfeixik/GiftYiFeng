		...
		<div class="center">
			...
			<div class="operate fr m-t-31 rel" id="user_operate">
				<a href="user.php" id="nav_user"><i
					class="icon-bgr icon-user m-7 ani-bg"></i> </a> <a href="flow.php"
			...
			<div class="user-left fl bg-fff">
				<p class="tc user-exit">
					<a class="icon-bgr icon-account" title="退出"
						href="/user.php?act=logout"></a><br> <span class="dib p-t-10">US000061443</span>
				</p>
				<ul class="tree-list m-t-28">
					<li><a href="/user.php?act=order_list" class="">我的订单</a>
					</li>
					<li><a href="/user.php?act=can_shaidan" class="">评价晒单</a>
					</li>
					<li class="m-t-15"><a href="/user.php?act=profile" class="">个人信息</a>
					</li>
					<li><a href="user.php?act=update_password" class="">修改密码</a>
					</li>
					<li><a href="/user.php?act=address_list" class="current">我的地址簿</a>
					</li>
					<li class="m-t-15"><a href="/user.php?act=bonus" class="">我的代金劵</a>
					</li>
					<li><a href="/user.php?act=point&amp;page=1" class="">我的积分</a>
					</li>
					<li class="m-t-15"><a href="/user.php?act=collection_list"
						class="">我的收藏</a>
					</li>
					<li><a href="/user.php?act=question_list" class="">我的提问</a>
					</li>
				</ul>
			</div>
		...
		<div class="top">
			<div class="center clear">
				...
				<div class="top-box3 fl">
					...
					<p class="m-t-10">
						<a href="http://weibo.com/liwuyou" target="_blank"
							class="icon-bgr icon-sina"></a> <a
							href="http://t.qq.com/liwuyou4006112156" target="_blank"
				...
				<div class="fl">
					<p class="f-c3c3c3">
						<span class="m-r-16">© liwuyou.com</span><span><a
							...
							target="_blank">粤ICP备10222238号-1</a> </span>
					</p>
				</div>
				<div class="fr">
					<p class="f-f5f5f5 f0">
