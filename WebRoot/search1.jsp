...
<body>
	<div id="app">
		<div class="header">
			<div class="center">
				...
				<div class="category tc fl" id="category">
					<a href="index.jsp" class="f16 lh2">礼艺坊<i
				...
				<div class="operate fr m-t-31 rel" id="user_operate">
					<a href="user.php" id="nav_user"><i
						class="icon-bgr icon-user m-7 ani-bg"></i> </a> <a
						href="shopping_cart.jsp" class="m-l-5" id="nav_cart"><i
				...
				<div class="search fr m-t-31">
					<input type="text" name="search" id="message"> <a
		...
		<div class="currentloc bg-f5f5f5 clear">
			<div class="center f12">
				<div class="fl">
					<a href="/">首页</a><span>/</span> <a href="/search1.jsp">礼物搜索</a><span>/</span>
				</div>
				<a
					...
					class="fr">服务热线：0755-86380505&nbsp;(8:00－24:00)</span> <span
					class="fr m-r-100 f-a5937d"></span>
			</div>
		</div>
					...
					<div class="query fl rel">
						...
						<dl class="clear">
							...
							<dd class="fl link-list">
								<template v-for="(item, index) in occation"> <a
									class="focus" v-if="index==0">全部</a> <a
									href="javascript:void(0);" @click="occationmethod($event)"
									id="occation">{{item}}</a> </template>
							</dd>
						</dl>
						<dl class="clear b-t-1">
							<dt class="fl tc">对象&nbsp;:</dt>
							<dd class="fl link-list">
								<template v-for="(item, index) in object"> <a
									class="focus" v-if="index==0">全部</a> <a
									href="javascript:void(0);" @click="objectmethod($event)"
									id="object">{{item}}</a> </template>
							</dd>
						</dl>
						<dl class="clear b-t-1">
							<dt class="fl tc">分类&nbsp;:</dt>
							<dd class="fl link-list">
								<template v-for="(item, index) in classify"> <a
									class="focus" v-if="index == 0">全部</a> <a
									href="javascript:void(0);" @click="classifymethod($event)"
									id="classify">{{item}}</a> </template>
							</dd>
						...
						<dl class="clear b-t-1">
							...
							<dd class="fl link-list">
								<template v-for="(item, index) in price"> <a
									class="focus" v-if="index == 0">全部</a> <a
									href="javascript:void(0);" @click="pricemethod($event)">{{item}}</a>
								<input type="hidden" id="price" :value="index" /> </template>
							</dd>
						</dl>
					</div>
			...
			<div class="center">
				<div class="cat-title clear p-y-20">
					<div class="sorts fl">
						...
						<a href="search.jsp" class="dib">畅销</a><span
							class="dib f-d4d4c7">｜</span> <a
							href="search.jsp" class="dib focus">最新</a><span
							class="dib f-d4d4c7">｜</span> <a
							href="search.jsp" class="dib">价格由低到高</a><span
							class="dib f-d4d4c7">｜</span> <a
							href="search.jsp" class="dib">价格由高到低</a>
				...
				<ul class="cat-list clear">
					...
					<li class="fl p-30 m-t-20 ani-bd-shadow rel"
						v-if="index == 0 || (index % 4) == 0"><i
						class="icon-bgr icon-bgcircle" v-if="goods.time < 3">新品</i> <a
						:href="goods.url" target="_blank" class="img-link"> <img
							:src="goods.image" class="normalpic focus"> </a>
						...
						<p class="f12 f-666 tr m-t-20 clear com-diy">
							<span class="fr">无人评价</span>
						</p>
					</li>
					<li class="fl p-30 m-l-20 m-t-20 ani-bd-shadow rel" v-else><i
						class="icon-bgr icon-bgcircle">新品</i> <a :href="goods.url"
						target="_blank" class="img-link"> <img :src="goods.image"
							class="normalpic focus"> </a>
						<p class="overtxt m-t-20 cat-name">
							<a :href="goods.url" target="_blank" :title="goods.name">{{goods.name}}</a>
						</p>
						<p>{{goods.price}}</p>
				...
				<div class="pages tc p-y-40">
					<a class="prev icon-bgr icon-page-l" href=""></a> <a
						href="search.php?keywords=&amp;environment_cat=0&amp;object_cat=0&amp;choice_cat=0&amp;brand=0&amp;sort=goods_id&amp;order=DESC&amp;min_price=&amp;max_price=&amp;action=&amp;intro=&amp;goods_type=0&amp;sc_ds=0&amp;outstock=0&amp;page=1"
						class="current">1</a> <a
						href="search.php?keywords=&amp;environment_cat=0&amp;object_cat=0&amp;choice_cat=0&amp;brand=0&amp;sort=goods_id&amp;order=DESC&amp;min_price=&amp;max_price=&amp;action=&amp;intro=&amp;goods_type=0&amp;sc_ds=0&amp;outstock=0&amp;page=2"
						class="">2</a> <a
						href="search.php?keywords=&amp;environment_cat=0&amp;object_cat=0&amp;choice_cat=0&amp;brand=0&amp;sort=goods_id&amp;order=DESC&amp;min_price=&amp;max_price=&amp;action=&amp;intro=&amp;goods_type=0&amp;sc_ds=0&amp;outstock=0&amp;page=3"
						class="">3</a> <a
						href="search.php?keywords=&amp;environment_cat=0&amp;object_cat=0&amp;choice_cat=0&amp;brand=0&amp;sort=goods_id&amp;order=DESC&amp;min_price=&amp;max_price=&amp;action=&amp;intro=&amp;goods_type=0&amp;sc_ds=0&amp;outstock=0&amp;page=4"
						class="">4</a> <a
						href="search.php?keywords=&amp;environment_cat=0&amp;object_cat=0&amp;choice_cat=0&amp;brand=0&amp;sort=goods_id&amp;order=DESC&amp;min_price=&amp;max_price=&amp;action=&amp;intro=&amp;goods_type=0&amp;sc_ds=0&amp;outstock=0&amp;page=5"
						class="">5</a> <a
						href="search.php?keywords=&amp;environment_cat=0&amp;object_cat=0&amp;choice_cat=0&amp;brand=0&amp;sort=goods_id&amp;order=DESC&amp;min_price=&amp;max_price=&amp;action=&amp;intro=&amp;goods_type=0&amp;sc_ds=0&amp;outstock=0&amp;page=6"
						class="">6</a> <a class="next icon-bgr icon-page-r"
						href="search.php?keywords=&amp;environment_cat=0&amp;object_cat=0&amp;choice_cat=0&amp;brand=0&amp;sort=goods_id&amp;order=DESC&amp;min_price=&amp;max_price=&amp;action=&amp;intro=&amp;goods_type=0&amp;sc_ds=0&amp;outstock=0&amp;page=2"></a>
				</div>
			</div>
		</div>
							...
							$.ajax({
				  				...
				  				success: function(data){
					 				...
					 				var jsonLength=Object.keys(data.search_list).length;
					 			 	...
					 			 	alert("data.search_list" +data.search_list);
	...
	<div class="toolbars tc" id="back_to_top"
		...
		<a
			href="http://crm2.qq.com/page/portalpage/wpa.php?uin=4006112156&amp;cref=http://www.liwuyou.com/&amp;ref=&amp;f=1&amp;ty=1&amp;ap=&amp;as="
			target="_blank" class="ani-bg"><i class="icon-bgr icon-qq"></i> </a>
		<a href="javascript:void(0)" class="ani-bg m-t-10"><i
			class="icon-bgr icon-totop"></i> </a>
	</div>
