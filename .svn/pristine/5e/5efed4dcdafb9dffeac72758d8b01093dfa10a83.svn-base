							...
							<tr>
								<td colspan="3">
									<div class="clear m-t-10">
										<span class="fl">共计1件商品<br>
										<b>合计：<span class="f-d93732">￥158.0</span>
										</b> </span> <a href="flow.php" class="fr btn-red-sml ani-bg">去购物车结算</a>
									</div></td>
							</tr>
						</tbody>
					</table>
			...
			<div class="user-left fl bg-fff">
				<p class="tc user-exit">
					<a class="icon-bgr icon-account" title="退出"
						href="logout"></a><br>
					<span class="dib p-t-10">${user.userName }</span>
				</p>
				<ul class="tree-list m-t-28">
					<li><a href="myOrderlist" class="">我的订单</a></li>
					<li class="m-t-15"><a href="UserInfo.jsp" class="">个人信息</a></li>
					<li><a href="UpdatePassword.jsp" class="current">修改密码</a></li>
					<li><a href="addressList" class="">我的地址簿</a></li>
					<li class="m-t-15"><a href="showMyCollect" class="">我的收藏</a></li>
				</ul>
			</div>
					...
					<div class="">
						<form>
							...
							<div class="info_li">
								...
								<div class="content">
									<input name="password3" id="password3" type="password"
										class="input" />
								</div>
							</div>
							<hr>
							<div class="info_li">
								<div class="">
									<input type="button" id="updatepassword" class="submit" value="提交修改">
								</div>
							</div>
						</form>
					</div>
	...
	<div class="footer">
		...
		<div class="bottom clear f-e7e7e7">
			...
			<div class="center links clear">
				<div class="fl">
					<p class="f-c3c3c3">
						<span class="m-r-16">© liwuyou.com</span><span><a rel="nofollow"
							>粤ICP备10222238号-1</a>
						</span>
					</p>
				</div>
