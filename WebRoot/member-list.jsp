...
function member_start(obj,id){
	layer.confirm('确认要启用吗？',function(index){
		...
		$(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none" onClick="article_stop(this,${sub.sId})" href="javascript:;" title="禁用"><i class="Hui-iconfont">&#xe6de;</i></a>');
